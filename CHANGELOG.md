-   **1.39.0**
	...
	-   Add a `GameAssetPathsSerde` class that contains binary serialization and deserialization methods for Addressables asset guids and paths. A `GameAssetPaths.bin` file is available.
